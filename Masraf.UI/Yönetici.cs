...
namespace Masraf.UI
{
    public partial class Yönetici : Form
    {
        ...
        private void Yönetici_Load(object sender, EventArgs e)
        {
            ...
            dataGridView1.DataSource = mRepo.SelecAllYön();
        }
        public void Veriler()
        {
            ndata.SaveChanges();
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            ekle.OnayDurumu = "Muhasebe".ToString();
            ekle.YetkiRol = 1;
            mRepo.Insert(ekle);
            Veriler();
            Temizle(this);
        ...
        private void comboBox1_SelectionChangeCommitted(object sender, EventArgs e)
        {
            if (comboBox1.SelectionLength > 0)
            {
                ...
                dataGridView1.DataSource = mRepo.selectMasrafID(masrafismi).Where(f => f.YetkiRol == 1 || f.YetkiRol == 2).Select(f => new
                {
                    f.Baslik,
                    f.Tutar,
                    f.Acıklama,
